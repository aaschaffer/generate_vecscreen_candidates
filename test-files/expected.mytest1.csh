...
/usr/bin/blastn -word_size 20 -ungapped -query /panfs/pan1.be-md.ncbi.nlm.nih.gov/infernal/notebook/17_0315_vecscreen_candidate_code_review/epn-2017.01.24/testfiles/A13775.1:1-42.na -db nr -show_gis -perc_identity 96 -xdrop_ungap 4 -dust no -outfmt " 6 qaccver sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore" -out /panfs/pan1.be-md.ncbi.nlm.nih.gov/infernal/notebook/17_0315_vecscreen_candidate_code_review/epn-2017.01.24/results1.out
